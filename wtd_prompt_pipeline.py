# -----------------------------------------------------------------------------
# This implementation supports unlimited weighted prompts with SDXL / Playground V2.
# See `EXAMPLE_DOC_STRING` at line 475 for a usage example.


# Core logic adapted from the official Hugging Face community example:
...
EXAMPLE_DOC_STRING = """
    Examples:
      ...
      custom_pipe = SDXLLongPromptWeightingPipeline(
          vae=vae,
      ...
      image = custom_pipe(
          prompt="""Underneath my (outside:1.7) (face:1.7)
There's a (face:1.7) that none can see.
A little less (smiley:0.9),
A little less sure,
